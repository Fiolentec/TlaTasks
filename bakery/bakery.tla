...
Inv == \A i \in Threads : 
             ...
             /\ (pc[i] \in {"m1", "m2"}) =>
                   \A j \in (Threads \ wanted[i]) \ {i} : CheckOrder(i, j)
             /\ (pc[i] = "cs") => \A j \in Threads \ {i} : CheckOrder(i, j)
             /\ /\ (pc[i] = "m2")
...
\* Last modified Wed Dec 30 20:54:38 YEKT 2020 by a18828568
